...
export default  function  CustomTemplate ({ config, pluginToggles }) {
	return (
		<>
			...
			<cq-side-nav cq-on='sidenavOn'>
				<div className='icon-toggles ciq-toggles'>
					...
					<cq-info-toggle-dropdown>
						...
						<cq-menu class='ciq-menu toggle-options '>
							<span></span>
							<cq-menu-dropdown>
					...
					<cq-info-toggle-dropdown>
						...
						<cq-menu class='ciq-menu toggle-options  tooltip-ui'>
							<span></span>
							<cq-menu-dropdown>
...
{/* 
					<cq-menu class='ciq-menu ciq-studies ' cq-focus='input'>
						<span>Studies</span>
						<cq-menu-dropdown>
					...
					<cq-menu class='ciq-menu ciq-preferences '>
						<span></span>
						<cq-menu-dropdown>
